...
import type {DrawingSubModuleConfig} from '../../domain/entities/drawingEntities';

interface DrawingSubModuleCardProps {
  readonly config: DrawingSubModuleConfig;
...
export function DrawingSubModuleCard({
  config,
  isUnlocked,
  starsEarned,
  isCompleted,
  onPress,
}: DrawingSubModuleCardProps) {
          ...
          <View style={styles.footerRow}>
            {isUnlocked ? (
              ...
              <Text style={styles.lockedText}>
                {t('drawing.lockedHint', 'Complete previous step')}
              </Text>
            )}
          </View>
        </View>
