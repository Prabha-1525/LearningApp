...
import {MathChoicePad} from '@features/math/presentation/components/MathChoicePad';
import {MathObjectCounter} from '@features/math/presentation/components/MathObjectCounter';
import {MathVisualPanel} from '@features/math/presentation/components/MathVisualPanel';
import {useInfiniteMathPractice} from '@features/math/presentation/hooks/useInfiniteMathPractice';
...
export function MathLessonScreen({navigation, route}: Props) {
  ...
  return (
    <AppSafeAreaView testID="math-lesson-screen">
      <TopAppBar
        title={title}
