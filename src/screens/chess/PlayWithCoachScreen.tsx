...
import {
  ...
  suggestChildMove,
  teachConceptLine,
} from '@features/chess/application/beginnerCoachAi';
import {
  chessComfortLine,
  chessGreetLine,
  chessHintLine,
  chessPraiseLine,
} from '@features/chess/application/coachAiLines';
import {
  applyMove,
  boardToPieceMap,
  createGame,
  gameStatus,
  legalMovesFrom,
} from '@features/chess/application/chessEngine';
import {
  speakCoachLine,
  stopCoachSpeech,
} from '@features/chess/application/coachSpeech';
import type {Square} from '@features/chess/domain/board/squares';
import {CelebrationStars} from '@features/chess/presentation/components/CelebrationStars';
...
export function PlayWithCoachScreen({navigation}: Props) {
  ...
  return (
    <AppSafeAreaView testID="chess-play-coach-screen">
      <TopAppBar
