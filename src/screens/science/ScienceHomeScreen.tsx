...
import {SCIENCE_TOPICS} from '../../features/science/domain/catalog/scienceData';
import {readScienceProgress} from '../../features/science/data/progress/scienceProgress';
import type {ScienceProgress} from '../../features/science/domain/entities/ScienceProgress';
import type {ScienceStackParamList} from '../../navigation/scienceTypes';

type Nav = NativeStackNavigationProp<ScienceStackParamList, 'Home'>;
    ...
    <AppSafeAreaView backgroundImage={null} backgroundColor="#F0FDF4">
      ...
      <View style={styles.header}>
        ...
        <View style={styles.headerTextWrap}>
          <Text style={styles.headerTitle}>
            {t('science.home.title', 'Little Scientist')}
          </Text>
          <Text style={styles.headerSubtitle}>
            {t('science.home.subtitle', 'Explore, discover & experiment!')}
          </Text>
        </View>
      ...
      <View style={styles.progressSection}>
        <Text style={styles.progressLabel}>
          {t('science.home.progress', {
            completed: completedCount,
            total: SCIENCE_TOPICS.length,
            defaultValue: `${completedCount} / ${SCIENCE_TOPICS.length} topics completed`,
          })}
        </Text>
        <View style={styles.progressTrack}>
          <View
            style={[
              styles.progressFill,
              {width: `${(completedCount / SCIENCE_TOPICS.length) * 100}%`},
            ]}
          />
        </View>
      </View>
        ...
        {SCIENCE_TOPICS.map(topic => {
          ...
          return (
            <Pressable
              ...
              onPress={() =>
                navigation.navigate(
                  topic.targetScreen as keyof ScienceStackParamList as any,
                )
              }
              style={({pressed}) => [
                styles.topicCard,
